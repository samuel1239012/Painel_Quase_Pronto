<?php
  ...
  if(isset($_GET['id'])&& is_numeric($_GET['id'])){
    ...
    // preparação da consulta no back-end
     ...
     // endpoint da API
     $end_point = "http://localhost/api_jornal/destaque_home/?id=$id";
     ...
     $arrdestaque_home = $dado["destaque_home"];
 
     if ($dado['status'] =='success'){
      $fk_noticia = $arrNoticia['fk_noticia'];
      $fk_redacao = $arrNoticia['fk_redacao'];
     }
  }
